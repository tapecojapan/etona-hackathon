...
class InAppPurchaseController extends StateNotifier<AdRemovalPurchaseState> {
  ...
  InAppPurchaseController(this.inAppPurchaseInstance)
      : super(AdRemovalPurchaseState.notStarted());
  ...
  Future<void> buy() async {
    ...
    final response = await inAppPurchaseInstance
        .queryProductDetails({AdRemovalPurchaseState.productId});
  ...
  void subscribe() {
    _subscription?.cancel();
    _subscription = inAppPurchaseInstance.purchaseStream
      ...
      switch (purchaseDetails.status) {
        ...
        case PurchaseStatus.restored:
          ...
          if (valid) {
            ...
            _adRemoval = AdRemovalPurchaseState.error(
